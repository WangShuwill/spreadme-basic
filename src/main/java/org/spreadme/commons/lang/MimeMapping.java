/*
 * Copyright [4/1/20 1:44 PM] [shuwei.wang (c) wswill@foxmail.com]
 *
...
public class MimeMapping {
	...
	static {
		...
		DEFAULT_MAPPING = Collections.unmodifiableMap(defaultMappings);
	}

	MimeMapping(Map<String, String> mapping) {
	...
	public static class Builder {
		...
		public Builder addMapping(final String extension, final String contentType) {
			mapping.put(extension.toLowerCase(Locale.ENGLISH), contentType);
			return this;
		}

		public MimeMapping build() {
			return new MimeMapping(mapping);
		}
	}

	public String getMimeType(final String extension) {
		return this.mapping.get(extension.toLowerCase(Locale.ENGLISH));
	}
}
