...
public class DateTypeHandler extends AbstractTypeHandler<Date> {
    ...
    @Override
    protected void setNonNullParameter(PreparedStatement ps, int index, Date parameter, JDBCType jdbcType) throws SQLException {
    ...
    @Override
    protected Date getNullableResult(ResultSet resultSet, int columnIndex) throws SQLException {
