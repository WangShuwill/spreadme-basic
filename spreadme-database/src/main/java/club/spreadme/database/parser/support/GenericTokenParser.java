...
public class GenericTokenParser {
    ...
    public GenericTokenParser(ExpressionHandler handler) {
        this.handler = handler;
    }

    public String parse(String text, String placeHolder) {
        if (text == null || text.isEmpty()) {
            return "";
        }
        String openToken = placeHolder.split("/")[0];
        String closeToken = placeHolder.split("/")[1];
        // search open token
