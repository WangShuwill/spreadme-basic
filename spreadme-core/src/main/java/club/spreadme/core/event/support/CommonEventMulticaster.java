...
package club.spreadme.core.event.support;

import club.spreadme.core.event.Event;
import club.spreadme.core.event.EventMulticaster;
import club.spreadme.core.event.IEventListener;
